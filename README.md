[CreativeGuard website](https://brendanwang.github.io/CreativeGuard/)
...
2. Put `creativeguard-1.0.1.jar` from `build/libs/` in the **server's `mods/` folder** and restart the server.
